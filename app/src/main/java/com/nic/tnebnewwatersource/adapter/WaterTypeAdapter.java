...
public class WaterTypeAdapter extends RecyclerView.Adapter<WaterTypeAdapter.MyViewHolder> {
    ...
    public WaterTypeAdapter(Context context, List<TNEBSystem> list, recyclerItemClicked recyclerItemClicked) {
    ...
    @NonNull
    @Override
    public WaterTypeAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final WaterTypeAdapter.MyViewHolder holder, final int position) {
        ...
        holder.commonRecyclerItemViewBinding.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerItemClicked.onItemClicked(position,"Water_Type");
            }
        });
    }

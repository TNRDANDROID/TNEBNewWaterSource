...
public class WaterSupplyTimingAdapter extends RecyclerView.Adapter<WaterSupplyTimingAdapter.MyViewHolder> {
    ...
    public WaterSupplyTimingAdapter(Context context, List<TNEBSystem> list,recyclerItemClicked recyclerItemClicked) {
    ...
    @NonNull
    @Override
    public WaterSupplyTimingAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final WaterSupplyTimingAdapter.MyViewHolder holder, final int position) {
        ...
        holder.commonRecyclerItemViewBinding.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerItemClicked.onItemClicked(position,"Supply_Timing");
            }
        });
    }

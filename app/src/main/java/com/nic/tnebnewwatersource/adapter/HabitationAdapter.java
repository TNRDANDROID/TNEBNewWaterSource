...
public class HabitationAdapter extends RecyclerView.Adapter<HabitationAdapter.MyViewHolder> {
    ...
    public HabitationAdapter(Context context, List<TNEBSystem> list,recyclerItemClicked recyclerItemClicked) {
    ...
    @NonNull
    @Override
    public HabitationAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final HabitationAdapter.MyViewHolder holder, final int position) {
     ...
     holder.commonRecyclerItemViewBinding.name.setText(list.get(position).getHabitation_name());
        ...
        holder.commonRecyclerItemViewBinding.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerItemClicked.onItemClicked(position,"Habitation");
            }
        });

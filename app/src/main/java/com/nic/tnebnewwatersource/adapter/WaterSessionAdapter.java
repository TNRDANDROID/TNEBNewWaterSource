...
public class WaterSessionAdapter extends RecyclerView.Adapter<WaterSessionAdapter.MyViewHolder> {
    ...
    public WaterSessionAdapter(Context context, List<TNEBSystem> list,recyclerItemClicked recyclerItemClicked) {
    ...
    @NonNull
    @Override
    public WaterSessionAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final WaterSessionAdapter.MyViewHolder holder, final int position) {
        ...
        holder.commonRecyclerItemViewBinding.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerItemClicked.onItemClicked(position,"Water_Session");
            }
        });
    }

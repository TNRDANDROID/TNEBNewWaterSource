...
import com.nic.tnebnewwatersource.databinding.SplashScreenBinding;
import com.nic.tnebnewwatersource.helper.AppVersionHelper;
...
public class SplashScreen extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* if(localLanguage != null && !localLanguage.equalsIgnoreCase(""))
        {
